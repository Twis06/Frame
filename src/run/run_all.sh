...
# cd /home/nv/px4_policy_deploy_plus;
source ~/.zshrc;
cd ~/px4_policy_deploy_plus;
source devel/setup.zsh;

# source /home/nv/px4_policy_deploy_plus/devel/setup.zsh;
echo "nv" | sudo -S chmod 777 /dev/ttyTHS0;
# sudo chmod 777 /dev/ttyACM0
roscore & sleep 20;
roslaunch px4ctrl run_camera_control.launch & sleep 4;
