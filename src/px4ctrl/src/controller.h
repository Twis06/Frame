...
struct Controller_Output_t
{
	...
	// Receiving timestamp of HIL commands (especially for HIL experiments)
	ros::Time rcv_stamp = ros::Time(0);

	void feed(mavros_msgs::AttitudeTargetConstPtr pMsg);
};
...
public:
	...
	/* blind attitude recovery controller from wdww */
...
private:
	...
	static constexpr double kMaxBodyratesFeedback_ = 6.0;
